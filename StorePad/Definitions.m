...
+ (UIColor *) tintColor
{
    ...
    if (!_tintColor)
    {
        _tintColor = [UIColor colorWithRed:(20.0f/255.0f) green:(75.0f/255) blue:(15.0f/255.0f) alpha:1.0f];
    }
...
+ (UIColor *) navigationBarTitleColor
{
    ...
    {
        _navigationBarTitleColor = [UIColor colorWithRed:(7.0f/255.0f) green:(37.0f/255) blue:(4.0f/255.0f) alpha:1.0f];
    }
...
+ (UIColor *) navigationBarBackgroundColor
{
    ...
    {
        _navigationBarBackgroundColor = [UIColor colorWithRed:(250.0f/255.0f) green:(248.0f/255) blue:(246.0f/255.0f) alpha:1.0f];
    }
